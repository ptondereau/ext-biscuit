...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBuilder_setContext, 0, 1, BiscuitBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, context, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBuilder_setRootKeyId, 0, 1, BiscuitBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, id, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBuilder_addFact, 0, 1, BiscuitBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, fact, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBuilder_addRule, 0, 1, BiscuitBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, rule, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBuilder_addCheck, 0, 1, BiscuitBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, check, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBuilder_build, 0, 2, BiscuitToken, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBlockBuilder_setContext, 0, 1, BiscuitBlockBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, context, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBlockBuilder_addFact, 0, 1, BiscuitBlockBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, fact, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBlockBuilder_addRule, 0, 1, BiscuitBlockBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, rule, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitBlockBuilder_addCheck, 0, 1, BiscuitBlockBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, check, IS_STRING, 0)
ZEND_END_ARG_INFO()

#define arginfo_class_BiscuitAuthorizerBuilder___construct arginfo_class_BiscuitBuilder___construct

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitAuthorizerBuilder_addFact, 0, 1, BiscuitAuthorizerBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, fact, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitAuthorizerBuilder_addRule, 0, 1, BiscuitAuthorizerBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, rule, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitAuthorizerBuilder_addCheck, 0, 1, BiscuitAuthorizerBuilder, 0)
	ZEND_ARG_TYPE_INFO(0, check, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_BiscuitAuthorizerBuilder_addPolicy, 0, 1, BiscuitAuthorizerBuilder, 0)
